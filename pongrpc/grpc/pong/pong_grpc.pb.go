...
type PongGameClient interface {
	...
	NotifyGameStarted(ctx context.Context, in *GameStartedRequest, opts ...grpc.CallOption) (PongGame_NotifyGameStartedClient, error)
}
...
func (c *pongGameClient) NotifyGameStarted(ctx context.Context, in *GameStartedRequest, opts ...grpc.CallOption) (PongGame_NotifyGameStartedClient, error) {
...
type PongGame_NotifyGameStartedClient interface {
	Recv() (*GameStartedResponse, error)
	grpc.ClientStream
}
...
func (x *pongGameNotifyGameStartedClient) Recv() (*GameStartedResponse, error) {
	m := new(GameStartedResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type PongGameServer interface {
	...
	NotifyGameStarted(*GameStartedRequest, PongGame_NotifyGameStartedServer) error
...
func (UnimplementedPongGameServer) NotifyGameStarted(*GameStartedRequest, PongGame_NotifyGameStartedServer) error {
...
type PongGame_NotifyGameStartedServer interface {
	Send(*GameStartedResponse) error
	grpc.ServerStream
}
...
func (x *pongGameNotifyGameStartedServer) Send(m *GameStartedResponse) error {
	return x.ServerStream.SendMsg(m)
}
